...
namespace SportsLeague.Domain.Services
{
    public class TeamService : ITeamService
    {
        ...
        public async Task<Team> CreateAsync(Team team)
        {
            ...
            {
                _logger.LogWarning("Team with name '{TeamName}' already exists", team.Name);//log warning para indicar que ya existe un equipo con ese nombre
                throw new InvalidOperationException(
                    $"Ya existe un equipo con el nombre '{team.Name}'");
            }

            _logger.LogInformation("Creating team: {TeamName}", team.Name);//log information para indicar que se está creando un nuevo equipo
