        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Player>(entity =>
            {
                ...
                entity.HasOne(p => p.Team)
                      ...
                      .OnDelete(DeleteBehavior.Cascade);//este borrador cascada hace que si se borra un equipo, se borren sus jugadores asociados, se debe colocar en todas las relaciones de uno a muchos
            ...
            modelBuilder.Entity<Sponsor>(entity =>
            {
                ...
                // Índice único para evitar sponsors repetidos
            ...
            modelBuilder.Entity<MatchLineup>(entity =>
            {
                ...
                // Evita jugadores duplicados en el mismo partido
